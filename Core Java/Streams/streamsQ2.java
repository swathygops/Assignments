...
public class streamsQ2 {
    ...
    public static void main(String[] args) {
        ...
        feb23.add(new News(1, "Anna", "amy", "comment"));
        feb23.add(new News(2, "sarah", "renni", "comment"));
        feb23.add(new News(3, "rana", "anu", "budget"));
        feb23.add(new News(2, "vijay", "Vijay", "budget "));
        feb23.add(new News(1, "varun", "surya", "costly"));
        feb23.add(new News(3, "Sarah", "anu", "costly"));
