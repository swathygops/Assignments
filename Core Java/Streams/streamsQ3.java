...
public class streamsQ3 {
    ...
    public static void main(String[] args) {
        ...
        t.add(new Trader("rana", "Bangalore"));
        t.add(new Trader("bunny", "Pune"));
        t.add(new Trader("charan", "Delhi"));
        t.add(new Trader("Rama", "Bhubaneswar"));
        t.add(new Trader("prabha", "Pune"));
        t.add(new Trader("naveen", "Indore"));
